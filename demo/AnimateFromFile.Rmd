...
download.file(url = "http://osm-extracted-metros.s3.amazonaws.com/sochi.osm.pbf",
              destfile='sochi.osm.pbf')  ## Download file into local directory

sochi_2013 = data_table_from_OSM_file('sochi.osm.pbf') ## Load OSM file for time lapse

saveGIF({                        ## Create a GIF. Note: requires ImageMagick.
